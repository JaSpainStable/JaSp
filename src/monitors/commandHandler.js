const { Monitor, InternCommand, Stopwatch, util: { regExpEsc, newError } } = require('../index');

const CommandMessage = InternCommand;
...
module.exports = class extends Monitor {
        ...
        async run(msg) {
            ...
            this.runCommand(this.makeProxy(msg, new InternCommand(msg, validCommand, prefix, prefixLength)), timer);
        }
